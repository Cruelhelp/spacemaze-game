    ...
    <div className="min-h-screen relative overflow-hidden bg-background flex flex-col">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10 flex-1">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          <div className="flex justify-center mb-6 animate-float animate-bounce-in">
            <Logo3D size="lg" />
          </div>
          ...
          <p className="text-base md:text-lg text-foreground/90 max-w-3xl mx-auto leading-relaxed pixel-font animate-slide-in-up" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8 animate-slide-in-up" style={{ animationDelay: "0.4s" }}>
            <Button 
              size="lg" 
              onClick={() => navigate("/game")}
              className="bg-primary hover:bg-primary/90 animate-pulse-glow text-lg md:text-xl px-10 py-7 pixel-font border-2 border-primary-foreground/20 hover:scale-105 transition-all shadow-[0_0_30px_rgba(168,85,247,0.5)] animate-slide-in-left"
            >
            ...
            <Button 
              ...
              className="border-2 border-secondary hover:border-secondary hover:bg-secondary/20 text-lg md:text-xl px-10 py-7 pixel-font hover:scale-105 transition-all hover:shadow-[0_0_30px_rgba(0,255,255,0.5)] animate-slide-in-right"
            >
          ...
          {/* Top Scores Preview */}
          {topScores.length > 0 && (
            <Card className="max-w-3xl mx-auto bg-card/80 backdrop-blur-lg border-2 border-primary/50 p-8 shadow-[0_0_50px_rgba(168,85,247,0.3)] animate-slide-in-up animate-bounce-in" style={{ animationDelay: "0.6s" }}>
              <h2 className="text-2xl md:text-3xl font-bold text-gradient mb-6 flex items-center justify-center gap-3 pixel-font glow-text animate-glow-pulse">
